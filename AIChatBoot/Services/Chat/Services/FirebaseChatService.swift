...
//  AIChatBoot
//
//  Created by Dhiman Das on 27.05.25.
//
...
//        return result.first
    ...
    func deleteChat(chatId: String) async throws {
        async let deleteChat: () = await collection.deleteDocument(id: chatId)
        async let deleteMessage: () = await messagesCollection(chatId: chatId).deleteAllDocuments()
